...
const Index = () => {
  ...
  const contentData = {
    protocolA1: `протокол А1 это миссия при которой альфис воскресила чару и Азриэля чтобы из них выпитывать энергию для ядра, но ядро от такого большого переизбытка энергии взорвалось`,

    reason: `либо Димасу лень делать видео либо у него депрессия`,
